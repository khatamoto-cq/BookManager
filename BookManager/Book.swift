...
extension Book {
    ...
    static func load() -> [[String : String]] {
        return [
            ...
            [Book.Name: "パーフェクトじゃないPHP", Book.Price: "3000", Book.PublishDate: "2013/04/13", Book.ImageUrl: "image3.png"],
            [Book.Name: "CakePHPじゃない辞典", Book.Price: "3000", Book.PublishDate: "2013/04/13", Book.ImageUrl: "image4.png"],
        ]
    }
}
